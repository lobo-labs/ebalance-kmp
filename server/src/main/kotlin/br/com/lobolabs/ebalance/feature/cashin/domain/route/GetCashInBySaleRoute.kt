...
fun Route.getCashInBySaleRoute() {

    val database by inject<Database>()

    // val firebase by inject<FirebaseManager>()

    val getCashInsBySaleUseCase by inject<GetCashInsBySaleUseCase>()
    ...
    get("/api/companies/{$paramCompanyId}/sales/{$paramSaleId}/cash-in") {
        ...
        database.useTransaction { transaction ->
            val getCashIn = getCashInsBySaleUseCase.execute(companyId, saleId)
